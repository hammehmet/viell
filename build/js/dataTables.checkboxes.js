...
(function( factory ){
   ...
   *     });
                ...
                if (ctx.aoColumns[i].checkboxes){
                    ...
                    if(ctx.aoColumns[i].mRender === null){
                        colOptions['render'] = function(){
                            return '<div class="position-relative"><input type="checkbox" class="dt-checkboxes"><label></label></div>';
                        };
                    }
    ...
    Checkboxes.defaults = {
         ...
         */
        selectAllRender: '<div class="position-relative"><input type="checkbox" class="all-checkboxes"><label></label></div>'
    };
